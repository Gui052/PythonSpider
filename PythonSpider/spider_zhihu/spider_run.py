...
import requests
from bs4 import BeautifulSoup as AS
import json
...
class ZhiHuClient(object):
    ...
    def __init__(self):
        ...
        if self.__cookie:
            ...
            soup = AS(self.open(r"http://www.zhihu.com/").text, "html.parser")
    ...
    def login(self, username, password):
        ...
        soup = AS(html, "html.parser")
        _xsrf = soup.find("input", {"name": "_xsrf"})["value"]  # 解析出_xsrf
        # 下载验证码图片
        while True:
...
if __name__ == '__main__':
    ...
    a = True
    client = ZhiHuClient()
    username = '18870953286'
    password = '2976351bbbzzz'
